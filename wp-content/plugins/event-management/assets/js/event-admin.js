jQuery(document).ready(function ($) {
    ...
    $('#add-schedule-btn').on('click', function () {
        ...
        const scheduleGroupCount = $('#event-schedule-container .schedule-group:last').length
        ? parseInt($('#event-schedule-container .schedule-group:last').attr('data-schedule-id')) + 1
        : 0;
        const newSchedule = `
    ...
    $('#event-schedule-container').on('click', '.add-slot , .add-time-slot-btn', function () {
